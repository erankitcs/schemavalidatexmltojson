...
'resources': ['string'], 
'detail': 
{'reference_id': '57a49e9c-9803-42b4-b3e3-51f3ffab0b8a-testfailedevent', 'payloadTrimed': 'no', 'payloadS3Key': '', 
'payload': '{"note": {"to": "Tove", "from": "Jani", "heading": "Reminder", "body": "Dont forget me this weekend! er.ankit.cs@gmail.com"}}',
'validationMsg': 'Given JSON data is Not Valid against Schema.',
 'isValid': False
 }
}
