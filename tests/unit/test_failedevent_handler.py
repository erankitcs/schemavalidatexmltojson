...
REGION = 'us-east-1'
DYNAMODB_TABLE_NAME = 'testfailedevent-dynamodb'
TEST_ID = '57a49e9c-9803-42b4-b3e3-51f3ffab0b8a-testfailedevent'
VALIDATION_FAILED_BUCKET = "testsuccessevent-failed-s3-bucket"
...
@mock.patch.dict(os.environ, {"VALIDATION_FAILED_BUCKET": VALIDATION_FAILED_BUCKET} )
class TestLambdaFunction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_success_bucket = self.s3.create_bucket(Bucket=VALIDATION_FAILED_BUCKET)
    ...
    def test_log_event(self):
        from failedValidationEventProcess.app import log_event
        LOG_MSG = "Converted JSON object is saved into S3 bucket."
        LOG_STATUS = "Invalid and Loaded"
    ...
    def test_xml_to_json(self):
        from failedValidationEventProcess.app import xml_to_json
        xmldata="""<note>
    ...
    def test_lambda_handler(self):
        from failedValidationEventProcess.app import lambda_handler
        from tests.unit.test_data.test_failedevent_payload import eventbridge_payload
